...
\name{Pierre-Canisius E. B.}{TACOLODJOU}
%\address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Republique du BENIN}
\mobile{(+229) 61-32-41-58}
...
%\twitter{@twit}
\linkedin{emmanuel-tacolodjou-10981a116}
%\reddit{reddit account}
%\xing{xing name}
%\extrainfo{test} % Other text you want to include on this line
\position{analyste programmeur{\enskip\cdotp\enskip}it security junior{\enskip\cdotp\enskip}administratueur reseau et systeme} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Pierre-Canisius Emmanuel Binouossi TACOLODJOU~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

%----------------------------------------------------------------------------------------
\begin{document}

%\begin{tikzpicture}[remember picture,overlay]
%   		\node [rectangle, fill=awesome-skyblue, anchor=north, minimum width=9cm, minimum height=%\paperheight+6cm] (box) at (-5cm,5cm){};
%	\end{tikzpicture}
...
\input{cv-sections/qualite.tex}

\vspace{3cm}% you should ajust this distance, to send your signature on the botom of the page.
\begin{flushleft}
